      ...
      <div class="">
        ...
        <div class="mt-5 flex justify-between">
          <div class="flex items-center">
            ...
            <div class="ps-4">
              <p class="text-slate-400 text-sm font-semibold">Free Delivery</p>
              <p class="text-sm font-semibold">1-2 day</p>
            </div>
          </div>
          <div class="flex items-center">
            <div class="bg-slate-100 p-2 rounded">
  ...
  <div class="container-fluid bg-gray-100">
    ...
    <div class="container mt-40 mx-auto px-28 py-10 bg-slate-50 rounded-xl">
      ...
      <p class="text-slate-500">
        ...
        dolores iure voluptate vero asperiores fugit earum quasi ducimus! Just
        as a book is judged by its cover, the first thing you notice Lorem ipsum
        dolor sit amet consectetur adipisicing elit. Nobis dolorum iste
        blanditiis rem officiis enim ipsa possimus quia, necessitatibus nam modi
